...
<body>
    ...
    <div class="formulario"> 
        ...
        <form method="get">
            ...
            <a target="" href="sinsecion.html"><div class="recordar"><center>iniciar como invitado</center></div></a>
            <a target="" href="https://www.google.mx"> <input type="submit" value="Iniciar">
            <a target="" href="contra.php"><div class="registrarse">Quiero hacer el registro</a>
